...
export const he: Locals = {
  ...
  settings: {
    ...
    dynamicColor: 'התאמה לצבעי הטלפון',
    dynamicColorHint: 'צובע מחדש כפתורים וכותרת בהתאם לרקע המכשיר שלך (אנדרואיד 12 ומעלה).',
  ...
  advanced: {
    navTitle: 'ילדים וקבוצות',
    navHint: 'צבע, קבוצה, מזון ותזכורות לכל ילד/ה.',
    title: 'ילדים וקבוצות',
    groups: 'קבוצות',
    ...
    kids: 'ילדים',
    kidsHint: 'הקישו על ילד כדי להגדיר צבע, קבוצה, מזון, תצוגה ותזכורות.',
    hiddenBadge: 'מוסתר',
    kidVisibility: 'הצגה בלוח הבקרה',
    accentColor: 'צבע מותאם',
    accentAuto: 'אוטומטי',
    accentMatchPhone: 'כמו הטלפון',
    accentKidHint: 'מבטל את צבע הקבוצה עבור ילד זה.',
    group: 'קבוצה',
    groupNone: 'ללא',
    kidReminders: 'תזמון תזכורות',
    kidRemindersHint: 'חל כאשר התזכורת המתאימה מופעלת במסך ההתראות.',
    groupName: 'שם הקבוצה',
  ...
  notifications: {
    ...
    title: 'התראות',
    groupGeneral: 'כללי',
    groupReminders: 'תזכורות',
    groupOngoing: 'התראות חיות',
    groupDigest: 'סיכום',
    enable: 'הפעלת התראות',
  ...
  about: {
    ...
    aboutMeTitle: 'עליי',
    aboutMeBody:
      'משה וינברג הוא מפתח Full-Stack שאוהב סדר ובהירות, ובונה מוצרים דיגיטליים בגישה מדויקת ומחושבת. בין הפרויקטים שלו נמצאת גם אפליקציית מובייל שנועדה להעניק למשתמשים חוויה פשוטה, נוחה ובטוחה.',
